...
{ TCustomDBGridView }
  ...
  protected
    ...
    procedure ChangeIndicator;
    procedure ChangeScale(M, D: Integer); override;
    function CreateColumns: TGridColumns; override;
    function CreateDataLink: TDBGridDataLink;
    ...
    procedure DataEditError(E: Exception; var Actn: TDBGridDataAction);
    procedure DataFieldUpdated(Field: TField);
    procedure DataLayoutChanged;
    procedure DataLinkActiveChanged;
    procedure DataRecordChanged(Field: TField);
    procedure DataSetChanged;
    procedure DataSetScrolled(Distance: Integer);
    procedure DataUpdateError(E: Exception; var Actn: TDBGridDataAction);
    ...
    procedure PaintIndicatorFixed;
    procedure PaintIndicatorGridLines;
    procedure PaintIndicatorHeader;
    procedure PaintIndicatorImage(Rect: TRect; DataRow: Integer);
    procedure SetEditText(Cell: TGridCell; var Value: string); override;
    procedure SetFieldText(Field: TField; const AText: string);
  ...
  public
    ...
    procedure ChangeEditText(const S: string);
    ...
    function GetIndicatorHeaderRect: TRect;
    function GetIndicatorFixedRect: TRect;
    function GetIndicatorImage(DataRow: Integer): Integer;
    function GetIndicatorImageRect(DataRow: Integer): TRect;
    function GetIndicatorWidth: Integer;
    procedure InvalidateGrid; override;
    procedure InvalidateRow(ARow: Integer); override;
    procedure Insert(AppendMode: Boolean);
